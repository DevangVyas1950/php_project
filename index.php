...
body { font-family: 'Segoe UI', sans-serif; background: linear-gradient(135deg, #1a7a4a 0%, #0d4d30 100%); min-height:100vh; display:flex; align-items:center; justify-content:center; }
...
.logo i { font-size:48px; color:#1a7a4a; }
.logo h1 { font-size:28px; color:#1a7a4a; font-weight:700; margin-top:8px; }
.logo p { color:#666; font-size:14px; }
.tabs { display:flex; border-bottom:2px solid #eee; margin-bottom:24px; }
.tab { flex:1; padding:10px; text-align:center; cursor:pointer; font-weight:600; color:#999; border-bottom:2px solid transparent; margin-bottom:-2px; transition:.2s; }
.tab.active { color:#1a7a4a; border-bottom-color:#1a7a4a; }
...
input:focus, select:focus { outline:none; border-color:#1a7a4a; }
.row2 { display:grid; grid-template-columns:1fr 1fr; gap:12px; }
.btn { width:100%; padding:12px; background:#1a7a4a; color:#fff; border:none; border-radius:8px; font-size:15px; font-weight:600; cursor:pointer; margin-top:8px; transition:.2s; }
.btn:hover { background:#145c37; }
